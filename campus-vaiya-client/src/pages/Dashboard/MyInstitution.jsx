              ...
              <form onSubmit={handleCreate} className="space-y-5">
                ...
                <div className="relative rounded-3xl border-2 border-dashed border-white/[0.08] p-8 text-center hover:border-white/[0.14] transition-colors">
                  ...
                  {formData.type !== 'Coaching' && (
                    <input className="inst-input mb-4 max-w-xs mx-auto block" name="eiinNumber" placeholder="EIIN Number" onChange={handleInputChange} />
                  )}
                  <input
                    type="file"
                    name={formData.type === 'Coaching' ? 'idCard' : 'license'}
                    onChange={handleFileChange}
                    className="text-sm text-slate-400 file:mr-4 file:py-2.5 file:px-6 file:rounded-full file:border-0 file:text-xs file:font-bold file:uppercase file:tracking-wider cursor-pointer"
