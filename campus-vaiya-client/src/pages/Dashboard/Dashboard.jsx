      ...
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            <ToolBox label="Lab Report" icon={<FileText />} color="text-pink-500" />
            <ToolBox label="AI Roadmap" icon={<Map />} color="text-cyan-500" />
            <ToolBox label="CGPA Calc" icon={<Calculator />} color="text-emerald-500" />
            <ToolBox label="Library" icon={<Library />} color="text-indigo-500" />
          </div>
...
const ToolBox = ({ icon, label, color }) => (
  <div className="bg-slate-900/60 p-4 rounded-3xl border border-slate-800/60 flex flex-col items-center gap-3 hover:-translate-y-1 transition-all cursor-pointer group">
    <div className={`${color} p-3 bg-slate-950 rounded-2xl group-hover:scale-110 transition-all`}>{icon}</div>
